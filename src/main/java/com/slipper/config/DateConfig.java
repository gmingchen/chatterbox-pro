...
import com.slipper.common.constant.LocalDateTimeConstant;
...
public class DateConfig {
    ...
    public LocalDateSerializer localDateSerializer() {
        return new LocalDateSerializer(DateTimeFormatter.ofPattern(LocalDateTimeConstant.DATE_PATTERN));
    }
    @Bean
    public LocalDateDeserializer localDateDeserializer() {
        return new LocalDateDeserializer(DateTimeFormatter.ofPattern(LocalDateTimeConstant.DATE_PATTERN));
    }
    @Bean
    public LocalTimeSerializer localTimeSerializer() {
        return new LocalTimeSerializer(DateTimeFormatter.ofPattern(LocalDateTimeConstant.TIME_PATTERN));
    }
    @Bean
    public LocalTimeDeserializer localTimeDeserializer() {
        return new LocalTimeDeserializer(DateTimeFormatter.ofPattern(LocalDateTimeConstant.TIME_PATTERN));
    }
